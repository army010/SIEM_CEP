...
public class WebVirusSubscriber implements StatementSubscriber {
    ...
    public String getStatement() {
        String logComplexQuery = "select * from ViruslogEvent((type = 'file' AND action = 'connection not terminated'  AND information LIKE 'threat was detected %')) having count(*) > 0";
